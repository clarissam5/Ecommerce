...
public class Shop {
	...
	public static void main (String args[]) {
		...
		Product prod1 = new Product("Business Ritual Women's Long Sleeve Top", 65.39, 4, 'L', "Blue");
		Product prod2 = new Product("The Art of Computer Programming", 190.54, "Books", 9, "Donald E. Knuth", "Education", "9788-429-1266-48);
		Product prod3 = new Product("Men's Business Casual Shirt", 57.10, 2, 'M', "Teal");
		Product prod4 = new Product("Organic Tumeric Soap", 11.25, 1);
		Product prod5 = new Product("Head First Design Pattern", 37.35, 3, "Eric Freeman");
